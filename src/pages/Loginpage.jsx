    ...
    <div className='grid md:grid-cols-[3fr_4fr] grid-cols-[1fr]  items-center '>
        ...
        <>
            ...
            <div className='flex flex-row gap-3 w-[100%] justify-center bg-white py-3 '>
                <img className='w-[35px]' src="../../logo/2.png" alt="" />
                <img className='w-[35px]' src="../../logo/3.png" alt="" />
                <img className='w-[35px]' src="../../logo/4.png" alt="" />
                <img className='w-[35px]' src="../../logo/5.png" alt="" />
            </div>
            <p>or</p>
            <Login />
